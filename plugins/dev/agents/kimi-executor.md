---
name: kimi-executor
description: Delegated executor pinned to the relay model kimi-k3. Use only when the user or a dev skill explicitly dispatches this agent; never auto-delegate routine work to it.
model: kimi-k3
---
